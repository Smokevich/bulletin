...
--
-- Хост: 127.0.0.1
-- Время создания: Мар 30 2022 г., 16:25
...
INSERT INTO `categories` (`id`, `name`, `description`, `url`) VALUES
(1, 'Транспорт', 'Здесь будет очень подробное описание для траспорта чтобы поисковики повышали ресурс в выдаче', 'transport'),
...
INSERT INTO `pages` (`id`, `url`, `file`) VALUES
(1, '', 'main.php'),
(2, 'create', 'create.php');
...
(7, 'Доширак', 'doshirak@yandex.ru', '50.00', '/upload/970521.jpg', 'Продам оптом доширак в любом объеме, имеются все вкусы кроме импортных. Цены меняются в зависимости от объема закупки. Звоните для уточнения деталей по номеру +765473563454', 4, '2022-03-30 17:35:30');
