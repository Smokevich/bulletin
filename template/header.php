        ...
        <div class="container-xl">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <?php 
                            if($getUrl == '/create.php') {
                                $linkCreateProduct = '<a class="nav-link active" href="/create.php">Создать объявление</a>';
                            } else{
                                $linkCreateProduct = '<a class="nav-link" href="/create.php">Создать объявление</a>';
                            }
                        ?>
